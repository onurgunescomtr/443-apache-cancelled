...
final class AdministrationAuth001 implements VerisanatSudoAuthentication{

    // Empty class for open source package.
	// There is no sudo auth for openSource pack
}

final class AdministrationPanel001 implements VerisanatSudoPanel{
